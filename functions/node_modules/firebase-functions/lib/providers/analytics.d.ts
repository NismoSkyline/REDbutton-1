...
/**
 * Registers a Cloud Function to handle analytics event.
 *
...
/**
 * Interface representing the user who triggered the event.
 */
export declare class UserDimensions {
    ...
    /** App information. */
    appInfo?: AppInfo;
    /** Information regarding the bundle in which these event were uploaded. */
...
/**
 * Interface representing the device that triggered these Firebase Analytics event.
 */
...
/**
 * Interface representing the geographic origin of the event.
 */
...
/**
 * Interface representing the application that triggered these event.
 */
...
/**
 * Interface representing the bundle in which these event were uploaded.
 */
