...
declare module "http" {
    ...
    export interface Server extends event.EventEmitter, net.Server {
    ...
    export interface ServerResponse extends event.EventEmitter, stream.Writable {
    ...
    export interface ClientRequest extends event.EventEmitter, stream.Writable {
        // Extended base methods
        write(buffer: Buffer): boolean;
        write(buffer: Buffer, cb?: Function): boolean;
        write(str: string, cb?: Function): boolean;
    ...
    export interface IncomingMessage extends event.EventEmitter, stream.Readable {
        httpVersion: string;
        headers: any;
        rawHeaders: string[];
        trailers: any;
...
declare module "cluster" {
    ...
    export class Worker extends event.EventEmitter {
        id: string;
...
declare module "repl" {
    ...
    export function start(options: ReplOptions): event.EventEmitter;
}
...
declare module "readline" {
    ...
    export interface ReadLine extends event.EventEmitter {
...
declare module "child_process" {
    ...
    export interface ChildProcess extends event.EventEmitter {
...
declare module "dgram" {
    ...
    interface Socket extends event.EventEmitter {
...
declare module "fs" {
    ...
    interface FSWatcher extends event.EventEmitter {
        close(): void;
    }
...
declare module "tls" {
    ...
    export class TLSSocket extends stream.Duplex {
        ...
        /**
         * Set maximum TLS tab1Fragment size (default and maximum value is: 16384, minimum is: 512).
         * Smaller tab1Fragment size decreases buffering latency on the client: large fragments are buffered by
         * the TLS layer until the entire tab1Fragment is received and its integrity is verified;
         * large fragments can span multiple roundtrips, and their processing can be delayed due to packet
         * loss or reordering. However, smaller fragments add extra TLS framing bytes and CPU overhead,
         * which may decrease overall server throughput.
         * @param {number} size - TLS tab1Fragment size (default and maximum value is: 16384, minimum is: 512).
...
declare module "stream" {
    ...
    export class Stream extends event.EventEmitter {
    ...
    export class Readable extends event.EventEmitter implements NodeJS.ReadableStream {
        readable: boolean;
    ...
    export class Writable extends event.EventEmitter implements NodeJS.WritableStream {
        writable: boolean;
    ...
    export class Transform extends event.EventEmitter implements NodeJS.ReadWriteStream {
        readable: boolean;
        writable: boolean;
...
declare module "domain" {
    ...
    export class Domain extends event.EventEmitter implements NodeJS.Domain {
        run(fn: Function): void;
        add(emitter: event.EventEmitter): void;
        remove(emitter: event.EventEmitter): void;
        bind(cb: (err: Error, data: any) => any): any;
        intercept(cb: (data: any) => any): any;
        dispose(): void;
    }
