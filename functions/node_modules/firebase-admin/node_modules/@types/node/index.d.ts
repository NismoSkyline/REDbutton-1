...
declare module "cluster" {
    ...
    export interface Cluster extends event.EventEmitter {
        Worker: Worker;
...
declare module "zlib" {
    ...
    export namespace constants {
        ...
        // Return codes for the compression/decompression functions. Negative values are errors, positive values are used for special but normal event.
...
declare module "net" {
    ...
    export interface Server extends event.EventEmitter {
...
declare module "dgram" {
    ...
    export interface Socket extends event.EventEmitter {
...
declare module "stream" {
    ...
    class internal extends event.EventEmitter {
    ...
    namespace internal {
        ...
        export class Readable extends event.EventEmitter implements NodeJS.ReadableStream {
            ...
            /**
             * Event emitter
             * The defined event on documents including:
             *   1. close
             *   2. data
             *   3. end
             *   4. readable
